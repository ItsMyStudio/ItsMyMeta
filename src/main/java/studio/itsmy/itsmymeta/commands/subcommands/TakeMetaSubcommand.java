...
public final class TakeMetaSubcommand extends AbstractMetaSubcommand {

    public TakeMetaSubcommand(MetaService metaService, MessageService messages) {
    ...
    public String permission() {
        return "itsmymeta.command.take";
    }

    @Override
    public String usage() {
        return "take <metaKey> [target] <amount>";
    }
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        Object updatedValue = takeValue(sender, metaKey, amount, target);
        messages.send(
            sender,
